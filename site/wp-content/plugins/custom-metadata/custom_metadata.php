            ...
            foreach ( $value as $v ) :
                  ...
                  switch ( $field->field_type ) :
                        ...
                        case 'select' :
                              ...
                              break;
                        case 'datepicker' :
                              $datepicker_value = !empty( $v ) ? esc_attr( date( 'd/m/Y', $v ) ) : '';
