...
(function($) {
      ...
      $.Zebra_Form = function(element, options) {
            ...
            plugin.filter_input = function(filter_type, evt, custom_chars) {
                  ...
                  if (key_code == null || key_code == 0 || key_code == 8 || key_code == 9 || key_code == 13 || key_code == 27)
                        return true;
                  key = String.fromCharCode(key_code);
                  if ((key == 'v' || key == 'a' || key == 'c' || key == 'x') && evt.ctrlKey)
                        return true;
                  if (filter.indexOf(key) > -1)
                        return true;
                  if (filter_type == 'number' && key == '-' && _get_caret_position(control) == 0)
                        return true;
                  if (filter_type == 'float' && ((key == '-' && _get_caret_position(control) == 0) || (key == '.' && _get_caret_position(control) != 0 && control.value.match(/\./) == null)))
                        return true;
                  return false;
            }
                                      ...
                                      if (rule_name == 'dependencies') {
                                            ...
                                            (function() {
                                                  ...
                                                  for (var proxy in conditions) {
                                                        ...
                                                        if ($proxy.length == 0)
                                                              $proxy = $('input[name="' + proxy + '[]"],select[name="' + proxy + '[]"],textarea[name="' + proxy + '[]"]', form);
                                                        ...
                                                        if ($proxy.length > 0) {
                                                              ...
                                                              // add it now
                                                              if ($.inArray(element, proxies[proxy]['elements']) == -1)
                                                                    proxies[proxy]['elements'].push(element);
                                                                          ...
                                                                          $proxy.each(function() {
                                                                                ...
                                                                                switch (type) {
                                                                                      ...
                                                                                      case 'submit':
                                                                                            ...
                                                                                            if ($form.data('zf_clicked_button') == $(this).attr('id'))
                                                                                                  value.push('click');
                                                                                ...
                                                                                if (!$.isArray(condition)) {
                                                                                      ...
                                                                                      $.each(condition, function(key) {
                                                                                            ...
                                                                                            $.each(value, function(index) {
                                                                                                  ...
                                                                                                  else if ($.isArray(condition[key]) && $.inArray(value[index], condition[key]) > -1)
                                                                                                        matches++;
                                                        ...
                                                        proxies[proxy]['event'] = function(e) {
                                                              ...
                                                              $.each(proxies[proxy]['elements'], function(index) {
                                                                    ...
                                                                    for (var element in conditions) {
                                                                          ...
                                                                          if (!proxies[element]['conditions'][function_name]())
                                                                                result = false;
                                                                          ...
                                                                          if (undefined != callback) {
                                                                                ...
                                                                                for (var i = 0; i < namespaces.length; i++)
                                                                                      ...
                                                                                      // throw an error and stop execution if context doesn't exist
                                                                                            ...
                                                                                            throw new Error('"' + namespaces[i] + '" namespace doesn\'t exist in the global scope!');
                                ...
                                if (undefined != validation_rules[element]) {
                                      ...
                                      if (true !== plugin.validate_control($element)) {
                                            ...
                                            var
                                                  ...
                                                  if ($element.data('file_info'))
                                                        $element.removeData('file_info');
                    ...
                    plugin.register = function(element) {
                          ...
                          if (undefined != attributes['name']) {
                                ...
                                if (element.hasClass('time'))
                                      attributes['name'] = attributes['name'].replace(/\_(hours|minutes|seconds|ampm)$/, '');
...
//                     }
                                      ...
                                      if (!plugin.settings.validate_all)
                                            break;
                                ...
                                for (var rule in control_validation_rules['rules']) {
                                      ...
                                      switch (rule) {
                                            ...
                                            case 'alphabet':
                                                  ...
                                                  switch (attributes['type']) {
                                                        ...
                                                        case 'textarea':
                                                              ...
                                                              if ($.trim(element.val()) != '' && !exp.test(element.val()))
                                            ...
                                            case 'custom':
                                                  ...
                                                  $.each(control_validation_rules['rules'][rule], function(index, args) {
                                                        ...
                                                        if (fn !== false)
                                                              control_is_valid = fn.apply(fn, args.slice(1));
                                                                                      ...
                                                                                      switch (match.character) {
                                                                                            ...
                                                                                            case 'M':
                                                                                                  ...
                                                                                                  if (match.character == 'D' || match.character == 'l')
                                                                                                        iterable = element.data('Zebra_DatePicker').settings.days;

                                                                                                  // if month is given as month name, we'll check against the names in the used language
                                                                                                  else
                                                                                                        iterable = element.data('Zebra_DatePicker').settings.months;
                                            ...
                                            case 'email':
                                                  ...
                                                  switch (attributes['type']) {
                                                        ...
                                                        case 'textarea':
                                                              ...
                                                              // if value is not an empty string and the regular expression is not matched, the rule doesn't validate
                                                              if ($.trim(element.val()) != '' && null == element.val().match(/^([a-zA-Z0-9_\-\+\~\^\{\}]+[\.]?)+@{1}([a-zA-Z0-9_\-\+\~\^\{\}]+[\.]?)+\.[A-Za-z0-9]{2,}$/))
                                                                    control_is_valid = false;
                                                        ...
                                                        case 'file':
                                                              ...
                                                              if (file_info) {
                                                                    ...
                                                                    var
                                                                            ...
                                                                            allowed_file_types = $.map(control_validation_rules['rules'][rule][0].split(','), function(value) {
                                                                                  return $.trim(value)
                                                                            }),
                                                                    ...
                                                                    $.each(matching_file_types, function(index, extension) {
                                                                          ...
                                                                          if ($.inArray(extension, allowed_file_types) > -1)
                                                                                found = true;
                                                          ...
                                                          switch (attributes['type']) {
                                                            ...
                                                            case 'regexp':
                                                                  ...
                                                                  switch (attributes['type']) {
                                                                        ...
                                                                        case 'textarea':
                                                                              ...
                                                                              // if value is not an empty string and the regular expression is not matched, the rule doesn't validate
                                                                              if ($.trim(element.val()) != '' && null == exp.exec(element.val()))
                                                                                    control_is_valid = false;
                                                            ...
                                                            case 'required':
                                                                        ...
                                                                        case 'select-one':
                                                                              ...
                                                                              if (element.hasClass('time') && element.get(0).selectedIndex == 0) {
                                                                                ...
                                                                                case 'select-multiple':
                                                                                      ...
                                                                                      if (element.get(0).selectedIndex == -1)
                                                                                            control_is_valid = false;
                                                              ...
                                                              if (!control_is_valid) {
                                                                    ...
                                                                    if (rule == 'custom')
                                                                          control_validation_rules.message = custom_rule_error_message;

                                                                    // for other rules set the error message's text
                                                                    else
                                                                          control_validation_rules.message = plugin.settings.validation_rules[id][rule_not_passed][plugin.settings.validation_rules[id][rule_not_passed].length - (rule_not_passed == 'length' && plugin.settings.validation_rules[id][rule_not_passed].length == 4 ? 2 : 1)];
                                            ...
                                            plugin.validate = function() {
                                                  ...
                                                  for (index in validation_rules) {
                                                        ...
                                                        if (!form_is_valid && !plugin.settings.validate_all)
                                                              break;
                                            ...
                                            var _get_caret_position = function(element) {
                                                  ...
                                                  if (element.type == 'text')
                                                        return (0 - duplicate.moveStart('character', -100000));
                                                  ...
                                                  for (var proxy in conditions) {
                                                        ...
                                                        // if we don't have a cached result of the result
                                                              ...
                                                              if (result) {
                                                                    ...
                                                                    if (!proxies[proxy] || !proxies[proxy]['conditions'][function_name]())
                                                                          result = false;

                                                              }

                                                              // cache the result
                                                              if (undefined == proxies_cache[proxy])
                                                                    proxies_cache[proxy] = {};
                                                              if (undefined == proxies_cache[proxy][conditions[proxy]])
                                      ...
                                      $.fn.Zebra_Form = function(options) {
                                            ...
                                            return this.each(function() {
                                                  ...
                                                  if (typeof plugin.settings.on_ready == 'function')
                                                        plugin.settings.on_ready();
                                            });
