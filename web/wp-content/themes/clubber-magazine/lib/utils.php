...
function cm_home_list_title($post_type, $title, $raw = false)
{
    ...
    <header>
        <h1>
            <a class="title" href="<?php echo ($raw) ? $post_type : get_post_type_archive_link($post_type); ?>">
                <?php echo $title; ?>
            </a>
        </h1>
    </header>
...
{
    ?>
    <a class="fr mr10" href="<?php echo ($raw) ? $post_type : get_post_type_archive_link($post_type); ?>">
        <?php echo $title; ?>
    </a>
    <?php
}
