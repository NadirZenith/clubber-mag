...
class Audio_Widget extends WP_Widget {
      ...
      function Audio_Widget() {
            ...
            $this->WP_Widget( 'audio-widget', __( 'CLUBBER - Audio Player', 'clubber' ), $widget_opts );
      }
      ...
      function widget( $args, $instance ) {
            ...
            global $post;
            $query = new WP_Query();
            $query->query( 'post_type=music&p=' . $id . '&posts_per_page=1' );
            echo '
    <div class="widgets-col">';
      ...
      <ul class="widget-audio-meta">';
        ...
        <li>Genre: ' . $genre . '</li>';
                  ...
                  if ( $data_audio != null ) {
                        echo '
        <li>Release date: ' . $pretty_date_d . ' ' . $pretty_date_M . '  ' . $pretty_date_yy . '</li>';
                  }
                  echo '
      </ul>';
                  ?> 
