...
if (is_admin()) {
      ...
      if (class_exists("SimpleAdsManager"))
            $samObject = new SimpleAdsManager();
}
...
if (class_exists("SimpleAdsManagerAdmin") || class_exists("SimpleAdsManager")) {
      ...
      function drawAd($args = null, $codes = false) {
            ...
            if (is_null($args))
                  echo '';
            if (is_object($samObject))
                  echo $samObject->buildSingleAd($args);
            else
                  echo '';
      }
      ...
      function drawAdsPlace($args = null, $codes = false) {
            ...
            if (is_null($args))
                  echo '';
            if (is_object($samObject))
                  echo $samObject->buildAd($args, $codes);
            else
                  echo '';
      }
      ...
      function drawAdsZone($args = null, $codes = false) {
            ...
            if (is_null($args))
                  echo '';
            if (is_object($samObject))
                  echo $samObject->buildAdZone($args, $codes);
            else
                  echo '';
      }
      ...
      function drawAdsBlock($args = null) {
            ...
            if (is_null($args))
                  echo '';
            if (is_object($samObject))
                  echo $samObject->buildAdBlock($args);
            else
                  echo '';
      }
