<?php
/*
  Plugin Name: Gravity Forms - kingtheme.net
        ...
        public static function add_mce_popup() {
                ...
                ?>
                                        ...
                                        <div style="padding:15px;">
                                                ...
                                                <a class="button" style="color:#bbb;" href="#" onclick="tb_remove();
                                                                return false;"><?php _e("Cancel", "gravityforms"); ?></a>
                                        </div>
                                </div>
                        </div>
                </div>
