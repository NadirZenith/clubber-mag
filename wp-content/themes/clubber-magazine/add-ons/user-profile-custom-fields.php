...
function clubber_mag_extra_profile_fields($user) {
        ...
        <table class="form-table">
                ...
                <tr>
                        ...
                        <td>
                                <?php $main_resource = get_user_meta($user->ID, 'main_resource', true) ?>
                                <p>
                                ...
                                <select name="main_resource">
                                        ...
                                        <option value="sello" <?php echo ($main_resource == 'sello') ? 'selected' : '' ?>>sello</option>
                ...
                <tr>
                        ...
                        <td>
                                <?php
                                if ($artist_page_id = (int) get_user_meta($user->ID, 'artist_page', true)) {
                                        $artist_page = get_post($artist_page_id);
                                        d($artist_page);
                                        echo get_the_post_thumbnail($artist_page->ID, array(50, 50))
                                        ?>
                                        <a href="<?php echo get_edit_post_link($artist_page->ID) ?>"><?php echo $artist_page->post_title; ?></a>
                                        (<?php echo $artist_page->post_status ?>)
                                        <?php
                                }
                                ?>
                                <select  style="width: 300px;height: 100px" name="user_artist_page" size="8" >
                                        ...
                                        <?php
                                        $query = new WP_Query(array('post_type' => 'artista', 'posts_per_page' => -1));
                                        if ($query->have_posts()) {
                                                while ($query->have_posts()) {
                                                        $query->the_post();
                ...
                <tr>
                        ...
                        <td>
                                ...
                                <select  style="width: 300px;height: 100px" name="user_label_page" size="8" >
                                        ...
                                        <?php
                                        $query = new WP_Query(array('post_type' => 'sello', 'posts_per_page' => -1));
                                        if ($query->have_posts()) {
                                                while ($query->have_posts()) {
                                                        $query->the_post();
                                                        ?>
