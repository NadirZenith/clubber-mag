...
function attitude_theme_options_do_page() {
                                          ...
                                          <table class="form-table">
                                                ...
                                                <td>
                                                      <select name="attitude_theme_options[front_page_category][]" id="frontpage_posts_cats" multiple="multiple" class="select-multiple">
                                                            ...
                                                            selected(true, true);
                                                      } ?>><?php _e('--Disabled--', 'attitude'); ?></option>
      <?php
      ...
      foreach ($categories as $category) :
            ?>
                                                                  <option value="<?php echo $category->cat_ID; ?>" <?php if (in_array($category->cat_ID, $options['front_page_category'])) {
...
function attitude_theme_options_validate($options) {
      ...
      if (function_exists('attitude_themeoption_invalidate_caches'))
            attitude_themeoption_invalidate_caches();
