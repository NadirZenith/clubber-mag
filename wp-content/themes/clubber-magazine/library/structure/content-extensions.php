                              ...
                              <article>
                                    ...
                                    <header class="entry-header">
                                          <h2 class="entry-title">
                                                -> ARCHIVE <- <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a>
                                          </h2><!-- .entry-title -->
                                    </header>
      ...
      function attitude_theloop_for_page() {
            ...
            if (have_posts()) {
                  while (have_posts()) {
                        ...
                        do_action('attitude_before_post');
                        ?>
                        <section class="m5 bg-50" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                              <article class="">
                                    ...
                                    <div class="entry-content clearfix medium">
                                          <?php the_content(); ?>
                                          <?php
                                          wp_link_pages(array(
                              ...
                              <article id="comment-<?php comment_ID(); ?>" class="comment">
                                    <header class="comment-meta comment-author vcard">
                                          ...
                                          printf('<a href="%1$s"><time pubdate datetime="%2$s">%3$s</time></a>', esc_url(get_comment_link($comment->comment_ID)), get_comment_time('c'),
                                                  /* translators: 1: date, 2: time */ sprintf(__('%1$s at %2$s', 'attitude'), get_comment_date(), get_comment_time())
                                          );
                                          ?>
                                    </header><!-- .comment-meta -->
