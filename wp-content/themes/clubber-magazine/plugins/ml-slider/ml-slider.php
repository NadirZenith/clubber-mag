...
if (!defined('ABSPATH'))
      exit;
//http://lab.dev/clubber-magazine-dev/wp-content/plugins/ml-slider
/* d(plugins_url('ml-slider')); */
define('METASLIDER_VERSION', '2.6.3');
/* define('METASLIDER_BASE_URL', plugins_url('ml-slider') . '/'); //plugin_dir_url(__FILE__) */
define('METASLIDER_BASE_URL', CLUBBER_PLUGIN_URL . '/ml-slider/'); //plugin_dir_url(__FILE__)
