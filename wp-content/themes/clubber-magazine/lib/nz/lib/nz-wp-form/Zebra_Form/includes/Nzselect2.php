 ...
 *  @package    Controls
 */
class Zebra_Form_Nzselect2 extends Zebra_Form_Control {
      ...
      function toHTML() {
            ...
            $html = '<select ' . $this->_render_attributes() . '>';

            if ( isset( $this->attributes[ 'value' ] ) && isset( $this->attributes[ 'data-text' ] ) )
                  $html.= '<option value="' . $this->attributes[ 'value' ] . '" selected="selected">' . $this->attributes[ 'data-text' ] . '</option>';

            $html.= '</select>';

            if ( isset( $this->attributes[ 'new-resource' ] ) ) {
                  $html .= '<a class="' . $this->attributes[ 'new-resource' ][ 'class' ] .'" '
                            .'data-fancybox-type="ajax" '
                            . 'href="' . $this->attributes[ 'new-resource' ][ 'url' ] .'" '
                            . '>' . $this->attributes[ 'new-resource' ][ 'text' ]. '</a>';
            }
